...
const courses=[
  ...
  {icon:Plane,title:"Internship Program",subtitle:"Multiple Programs",description:"Airline Operations, Drone Tech, AME, NDT, Composites, and Manufacturing.",duration:"3-6 Months",tag:"Training",color:"bg-rose-600",light:"bg-rose-50 border-rose-200",tagBg:"bg-rose-100 text-rose-700",featured:false},
  {icon:FileCheck,title:"Career Upscale - Training",subtitle:"Special Program",description:"For industry professionals, practicing engineers and faculty members. Duration – Depends on training needs.",duration:"Special Program",tag:"Training",color:"bg-emerald-600",light:"bg-emerald-50 border-emerald-200",tagBg:"bg-emerald-100 text-emerald-700",featured:false},
]
