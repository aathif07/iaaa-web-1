...
const memberships = [
  {
    ...
    period: "/year",
    tag: "Most Popular",
    features: ["4-10 certified courses per year","National contests & internships","Workshops and training programs","Official IAAA certificate","Career support & mentorship"],
    cta: "Join as Student",
  ...
  },
  {
    ...
    period: "Volunteer",
    tag: "Open",
    features: ["Network with industry leaders","Mentor student members","Contribute to research initiatives","Professional recognition","Event participation"],
  ...
  },
  {
    ...
    period: "Pricing",
    tag: "Enterprise",
    features: ["Host IAAA Collegiate Clubs","Establish Regional Hubs","Run PTDC Centres","Faculty development programs","National recognition"],
